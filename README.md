...
For the move into the final project, see the [FinTrust portfolio and capstone plan](portfolio-and-capstone-plan.md) or the [PDF report](capstone-report.pdf). They separate the work already documented in the repository from the AWS Console build, evidence, and presentation work still required.
