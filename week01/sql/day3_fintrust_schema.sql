-- Week 1 Day 3: FinTrust core database schema
-- MySQL 8.x

CREATE DATABASE IF NOT EXISTS fintrust_db;
USE fintrust_db;

-- Rebuild the lab tables in foreign-key order so the script is repeatable.
...
INSERT INTO customers (first_name, last_name, email, province)
VALUES
...
INSERT INTO transactions
    (account_id, transaction_type, amount, merchant_category)
VALUES
